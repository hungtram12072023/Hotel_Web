    ...
    public partial class trangchu : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Convert.ToString(Session["email"]) == "admin@gmail.com")
            {
                ...
                string chaob = $@"<h1>Xin chào <span class='tenhthi'>{Session["name"]}</span> đến với HQH</h1>";
                chaowc.InnerHtml = chaob;
                string andkdn= "<script>document.getElementById('dnhapdky').style.display = \"none\"</script>";
                dnhapdky.InnerHtml=andkdn;
            }
