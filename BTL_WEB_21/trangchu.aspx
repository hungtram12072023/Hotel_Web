...
<body>
    ...
    <div class="chao" id="chaowc" runat="server"><h2>Chào mừng bạn đến với HQH-Team</h2></div>
    Đặt phòng, chỗ ở, trải nghiệm tuyệt vời và bạn sẽ cảm nhận nhiều hơn nữa trên HQH-Team
    <div id="dnhapdky" runat="server"><b><a href="dangnhap.aspx" class="phu">Đăng nhập</a></b> hoặc <b><a href="dangky.aspx" class="phu">Đăng ký</a></b> để nhận các ưu đãi đặc biệt</div>
    <center>
    <hr />
    </center>
    <div class="điaiemnoibat">
        ...
        <div class="pchiadd">
            <center>
            <div class="xly1"><a href="tintuc.aspx"><img class="nbat" src="App_Start/img/content5.jfif" /></a><br /><h3>Hà Nội</h3></div>
            <div class="xly1"><a href="tintuc.aspx"><img class="nbat" src="App_Start/img/content6.jfif" /></a><br /><h3>Thanh Hóa</h3></div>
            <div class="xly1"><a href="tintuc.aspx"><img class="nbat" src="App_Start/img/anhsapa.jfif" /></a><br /><h3>Sapa</h3></div>
            <div class="xly1"><a href="tintuc.aspx"><img class="nbat" src="App_Start/img/content2.jpg" /></a><br /><h3>Hạ Long</h3></div>
            <div class="xly1"><a href="tintuc.aspx"><img class="nbat" src="App_Start/img/anhconten2.jpg"/></a><br /><h3>Đà Nẵng</h3></div>
            </center>
        </div>
    </div>
    <div class="khuyenmai">
        ...
        <div class="pchiakmai">
            <center>
            <div class="xly2"><a href="sanpham.aspx"><img class="kmai" src="App_Start/img/km1.png" /></a></div>
            <div class="xly2"><a href="sanpham.aspx"><img class="kmai" src="App_Start/img/km2.png" /></a></div>
            <div class="xly2"><a href="sanpham.aspx"><img class="kmai" src="App_Start/img/km3.png" /></a></div>
            <div class="xly2"><a href="sanpham.aspx"><img class="kmai" src="App_Start/img/km4.png" /></a></div>
            <div class="xly2"><a href="sanpham.aspx"><img class="kmai" src="App_Start/img/km5.png"/></a></div>
            <div class="xly2"><a href="sanpham.aspx"><img class="kmai" src="App_Start/img/km6.png"/></a></div>
            </center>
        </div>
    </div>
        <div class="huongdan"> 
