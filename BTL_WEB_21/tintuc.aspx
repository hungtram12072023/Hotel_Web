...
<body>
   <header id="hd" class="hd1">
    ...
    <div class="conten">
        <div><a href="sanpham.aspx"><img class="anhbn" src="App_Start/img/thuyenhl.jpg" /></a></div>  
    ...
    <div class="pchiadlich">
        <div class="dlich1">
            <div>
                <a href="sanpham.aspx"><img class="btay" src="App_Start/img/anhconten2.jpg" /></a>
            </div>
         ...
         <div class="dlich2">
            <div>
                <a href="sanpham.aspx"><img class="cdong" src="App_Start/img/content6.jfif" /></a>
            </div>
         ...
         <div class="dlich3">
            <div>
                <a href="sanpham.aspx"><img class="con" src="App_Start/img/sapa.jpg" /></a>
            </div>
          ...
          <div class="dlich4">
            <div>
                <a href="sanpham.aspx"><img class="con" src="App_Start/img/hnoi.jpg" /></a>
            </div>
    ...
    <div class="bv"><a href="sanpham.aspx"><img class="vb" src="App_Start/img/bviet1.jpg" /></a>
        <div class="kt"><h2>8 địa điểm du lịch từ Hồ Chí Minh</h2></div></div>
    <div class="bv"><a href="sanpham.aspx"><img class="vb" src="App_Start/img/bviet2.jpg" /></a>
        <div class="kt"><h2>6 địa điểm du lịch từ Hà Nội</h2></div></div>
    <div class="bv"><a href="sanpham.aspx"><img class="vb" src="App_Start/img/bviet5.jpg" /></a>
        <div class="kt"><h2>9 địa điểm du lịch từ Nha Trang</h2></div></div>
    <div class="bv"><a href="sanpham.aspx"><img class="vb" src="App_Start/img/bviet4.jpg" /></a>
     <div class="kt"><h2>3 địa điểm du lịch từ Khánh Hòa</h2></div></div>
       <center><hr /></center> 
    <h1>Cẩm nang du lịch</h1>
    <div class="cn">
        <a href="sanpham.aspx"><img class="nc" src="App_Start/img/cnang1.jpg" /></a><br />
        <h3>Review Sapa-</h3><br />
        Trải nghiệm không gian thoáng đãng của SaPa
    </div>
    <div class="cn">
        <a href="sanpham.aspx"><img class="nc" src="App_Start/img/cnang2.jpg" /></a>
        <h3>Review Đà Lạt-</h3><br />
        Trải nghiệm không gian thoáng đãng của Đà Lạt
    </div>
    <div class="cn">
        <a href="sanpham.aspx"><img class="nc" src="App_Start/img/cnang3.jpg" /></a>
